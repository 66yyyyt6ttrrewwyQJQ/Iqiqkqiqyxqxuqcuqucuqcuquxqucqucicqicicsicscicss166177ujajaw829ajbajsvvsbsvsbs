...
--// unload hook
if environment and environment().Nyura ~= nil and rawequal(typeof(environment().Nyura.Unload), "function") then
	pcall(environment().Nyura.Unload, 1)
end
